...
public class SortingTest {
    ...
    public static void main(String[] args) {
           ...
           int[] chooseDistribution = {1,2};
           System.out.println("Normal Distribution");
           for (int index = 0; index <  chooseDistribution.length; index++) {
               for (int indexj = 0; indexj <input.length; indexj++) {
                   test(input[indexj], index);
               }
    ...
    public static void test(int input, int distribution){
        ...
        System.out.println("Merge Sort for output "+ input+" is  " + (endTime-startTime) + " in Millisecond");

        System.out.println("---------");
        startTime = System.nanoTime();
        double[] sortedList= bucketsort(bucketnumbers);
        endTime = System.nanoTime();
        System.out.println("Bucket Sort for output "+ input+" is  " + (endTime-startTime) + " in Millisecond");
        System.out.println("---------");

        startTime = System.nanoTime();
        InsertionSort(insertionnumbers);
        endTime = System.nanoTime();
        System.out.println("Insertion Sort for output "+ input+" is " + (endTime-startTime) + " in Millisecond");
        System.out.println("---------");
    }
    ...
    public static double[] bucketsort(double[] number) {
        ...
        LinkedList[] bucket = new LinkedList[number.length];
