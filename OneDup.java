...
public class OneDup{
    ...
    public static void main(String[] args){
        ...
        int ActualSum       = od.ActualSumofNumbers(numbers);
        int trueSum         = od.SumOfNNumbers(totalNumber);
        int duplicate       = od.findDuplicate(ActualSum,trueSum);
        od.printDuplicate(duplicate);
    }
     ...
     */
    public  int findDuplicate(int actualSum, int trueSum){
     ...
     */
    public  int ActualSumofNumbers(int[] numbers){
        int tempSum      = 0;
     ...
     * @return null
     */
    public  void printDuplicate(int number){
