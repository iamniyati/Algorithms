...
public class CountShortestPaths {
   ...
   static GraphNode [] graph;
    ...
    public static void main(String[] args) throws IOException{
        CountShortestPaths pth = new CountShortestPaths();
        ...
        for(int i=0;i<edges;i++){
            ...
            pth.makegraph(nodea,nodeb);
        }
        pth.findPath(startNode,endNode, nodes, distance);
     ...
     *
     */
    public  void makegraph(int nodea, int nodeb){
     ...
     * @param : int[] distance: distance array
     * @return None
     *
     */
    public  void findPath(int startNode, int endNode, int nodes, int[] distance){
         boolean[] seen;
        int count =0;
     ...
     *
     */
    public  void checkPath( int tempDist, int count ){
        int mindist =999;
