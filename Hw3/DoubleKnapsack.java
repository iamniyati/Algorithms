...
public class DoubleKnapsack {
    ...
    static int Knapsack1;
    static int Knapsack2;
    static Node [] itemsArray;
    static int [][][] knapsackArray;
    ...
    public static void main(String[] args)throws IOException {
        ...
        CalculateKnapSack(itemsArray, knapsackArray, totalNumber, Knapsack1,  Knapsack2);
    }
     ...
     *
     */
    public static void CalculateKnapSack(Node[] itemsArray,int[][][] knapsackArray,int Number,int Knapsack1, int Knapsack2){
